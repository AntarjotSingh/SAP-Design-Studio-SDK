define(["d3","sap/designstudio/sdk/component", "css!../css/component.css"], function(d3,Component, css) {
	Component.subclass("com.sap.mchart.MChart", function() {
		...
		*//*
			...
			*/
			...
			//	console.log(initialValue+ " "+finalValue);
				jsonData.push({name : dt[initialValue].d2, region : data_a, income: data_x, population: data_r, lifeExpectancy: data_y});
				k = finalValue;
				data_x = [];
				data_y = [];
				data_r = [];
